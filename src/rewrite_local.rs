...
use crate::rewrite::{
    RewritePrompt, build_oaicompat_messages_json, build_prompt, effective_max_output_chars,
    effective_max_tokens, sanitize_rewrite_output,
};
...
impl LocalRewriter {
    ...
    pub fn rewrite_with_instructions(
        ...
        let effective_max_output_chars =
            effective_max_output_chars(self.max_output_chars, transcript);
        ...
        for i in 0..effective_max_tokens {
            ...
            if output.contains("</output>") || output.len() >= effective_max_output_chars {
                break;
            }
